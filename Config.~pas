...
Form3.Image2.Width := strtoint(Edit3.Text);
Form3.Image2.Height := strtoint(Edit4.Text) + 2;
...
Form3.Image2.Width := Screen.Monitors[1].Width;
Form3.Image2.Height := Screen.Monitors[1].Height + 2;
end;
